...
% For PC-SAKE
para.PCSAKE.p = 0.1;
para.PCSAKE.ncalib = 48;
para.PCSAKE.ksize = [3, 3];
para.PCSAKE.nIter = 50;
para.PCSAKE.verbose_ind_coil = [];
% para.PCSAKE.verbose_ind_coil = [11 21];
para.PCSAKE.threshold_list=[4*ones(1,10),4.5*ones(1,15),5*ones(1,30),4.5*ones(1,15),4*ones(1,10)];
